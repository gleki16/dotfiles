...
widgets_list = [
    widget.GroupBox(active=color[3], disable_drag=True, hide_unused=True),
    widget.CurrentLayout(background=color[1]),
    widget.WindowTabs(),

    widget.Chord(background=color[1]),
    widget.DF(),
    widget.PulseVolume(),
    widget.Systray(background=color[1]),
